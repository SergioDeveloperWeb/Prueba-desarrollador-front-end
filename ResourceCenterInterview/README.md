...
Esta es una versión optimizada y completamente resuelta para la prueba técnica frontend sobre el stack **ASP.NET Core MVC + Razor + jQuery + SCSS**.

El proyecto ha sido rediseñado visualmente bajo una estética minimalista premium y corregido a nivel funcional, garantizando máxima accesibilidad (A11y), rendimiento y persistencia.
...
*   **SDK de .NET 8.0**
*   **Node.js & npm** *(Recomendado para compilar SCSS fácilmente en cualquier OS)*

---

## 🚀 Guía de Arranque (Paso a Paso)

Elige la opción que mejor se adapte a tu sistema operativo o entorno:

### Opción A: Método Estándar (Recomendado - Windows, macOS y Linux)
Utiliza este método si dispones de **Node.js** y **.NET SDK** globales en tu equipo.

1. **Restaurar paquetes de NuGet (.NET):**
   Desde la raíz de la carpeta `ResourceCenterInterview`, ejecuta en tu terminal:
   ```bash
   dotnet restore
   ```

2. **Instalar dependencias frontend y compilar SCSS:**
   Instala las herramientas de desarrollo local (incluyendo Sass) y genera la hoja de estilos CSS:
   ```bash
...
Una vez que el servidor esté en funcionamiento por cualquiera de los métodos anteriores, abre tu navegador favorito e ingresa a la siguiente dirección:
...
*   **Lógica Interactiva (JS / jQuery):** [resource-center.js](file:///home/homedev/Documentos/prueba/technical-challenge-front/ResourceCenterInterview/wwwroot/technical-test/resource-center.js) — *Filtros, modales, persistencia y eventos.*
*   **Diseño y Hoja de Estilo (SCSS):** [resource-center.scss](file:///home/homedev/Documentos/prueba/technical-challenge-front/ResourceCenterInterview/wwwroot/technical-test/resource-center.scss) — *Arquitectura CSS, variables, micro-animaciones y glassmorphism.*
*   **Estructura Razor (HTML):** [ResourceCenter.cshtml](file:///home/homedev/Documentos/prueba/technical-challenge-front/ResourceCenterInterview/Views/TechnicalTest/ResourceCenter.cshtml) — *Estructura accesible y carga de assets.*
